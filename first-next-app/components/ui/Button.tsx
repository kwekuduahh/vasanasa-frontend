...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({
  ...
  const variants = {
    primary: 'bg-[#1d49a8] text-white hover:bg-[#1a3f96] active:bg-[#163584] focus:ring-[#1d49a8]',
    secondary: 'bg-[#ffffff] text-[#040404] hover:bg-gray-50 active:bg-gray-100 focus:ring-gray-300',
  ...
  return (
    ...
    >
      ...
      <span className={`${loading ? 'opacity-75' : ''} ${iconName ? 'mr-2' : ''}`}>
        {children}
      </span>
      {iconName && !loading && (
